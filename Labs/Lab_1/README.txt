Instructions:
	...
	Overview:
		...
		This page design should be simple to work with. It contains a number of modular pieces
		but at its heart, aside from a main page <header> and <footer>, it's pretty much just a stack of
		"main" <section> elements that follow the same basic pattern:
